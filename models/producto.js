...
const ProductoSchema = Schema({
    ...
    precio : {
        ...
        type: Number,
        default: 0 // el precio por default va a hacer 0

    },

    categoria:{

        type: Schema.Types.ObjectId, // haciendoo relacion con mis categorias 
        ref:  'Categoria', // la referencia va a hacer a la coleccion de Categoria 
        required: true
    ...
    disponible: {
            ...
            type: Boolean,
            default: true // por defecto va a hacer true 
...
ProductoSchema.methods.toJSON = function(){ // tiene que ser una funcion normal, porque vamos a utilizar thisy en la funcion de flecha no se puedse

    // cuando se mande a llamar el toJson se va a generar esta funcion que va a quitar o sacar  el Password y la version __v
   
   
       const {__v,estado , precio , disponible,  ...data} = this.toObject(); //  nos va a generalizar una instancia de los valores respectivos de este modelo
